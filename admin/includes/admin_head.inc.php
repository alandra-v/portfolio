...
<head>
  ...
  <link rel="stylesheet" href="<?= BASE_URL . 'admin/css/variables.css' ?>">
  ...
  switch ($currentPage) {
    ...
    case 'password_reset.php':
      ...
      '<link rel="stylesheet" href="' . BASE_URL . 'admin/css/password_requirements.css">',
      '<script src="' . BASE_URL . 'admin/js/password_reset.js" defer></script>',
      '<script src="' . BASE_URL . 'admin/js/password_functions.js" defer></script>';
      break;
    ...
    case 'account_settings.php':
      ...
      '<link rel="stylesheet" href="' . BASE_URL . 'admin/css/cms_nav.css">',
      '<link rel="stylesheet" href="' . BASE_URL . 'admin/css/confirmation_modal.css">',
      '<script src="' . BASE_URL . 'js/back_to_top_btn.js" defer></script>',
      '<script src="' . BASE_URL . 'admin/js/cms_nav.js" defer></script>',

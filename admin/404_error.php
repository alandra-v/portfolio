...
<head>
  ...
  <link rel="stylesheet" href="css/404_error.css">
  ...
  <main>
    <div class="error-container">
      <div class="error-polygon-container">
        <picture>
         <source media="(min-width: 760px)" srcset="../assets/illustrations/404_polygon.webp 1200w,
                          ../assets/illustrations/404_polygon.png 1200w">
          <source srcset="../assets/illustrations/404_polygon_small.webp 600w,
                          ../assets/illustrations/404_polygon_small.png 600w">
                          <img src="../assets/illustrations/404_polygon.png" alt="404 polygon illustration" class="error-polygon" width="600" height="291">
        </picture>
      </div>
      <div class="msg">
        <h1>Page not found</h1>
        <p>Sorry, the page you are looking for might have been removed or temporarily unavailable.</p>
        <a href="../index.php" class="bth-btn">Back to home</a>
      </div>
    </div> 
  </main>
</body>

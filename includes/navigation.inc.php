    <nav>
      ...
      <div class="overlay-menu">
        <ul class="overlay-content">
          ...
          <li><a href="contact.php" class="contact-button-menu">CONTACT</a></li>
          <li>
            <ul class="small-menu">
              <li><a href="legal_disclosure.php">Legal disclosure</a></li>
      ...
      <ul class="site-nav">
        ...
        <li><a href="work.php">Work</a></li>
        <li><a href="about.php">About</a></li>
        <li><a href="contact.php" class="contact-button-header">CONTACT</a></li>
      </ul>
    </nav>